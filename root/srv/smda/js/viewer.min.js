...
"magnification"]/b.max_row,l=(h&&"horizontal_flip"in h?-k:k)*(h&&"xscale"in h?h.xscale:1),w=(h&&"vertical_flip"in h?-k:k)*(h&&"yscale"in h?h.yscale:1),A=$jscomp.makeIterator([Math.sign(l),Math.sign(w)]),I=A.next().value;A=A.next().value;var B=$jscomp.makeIterator([d.pan_x*b.max_col,d.pan_y*b.max_row]),J=B.next().value;B=B.next().value;var D=Math.log2(b.max_row),n=Math.pow(2,D),m=c.view_left*n,q=c.view_bottom*n,u=c.view_right*n,x=c.view_top*n;n=[[m,q],[m,x],[u,q],[u,x]];if(h=h&&"rotate"in h?h.rotate:
0){var E=Math.cos(-h),F=Math.sin(-h);n=n.map(function(a){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return[a*E-b*F,a*F+b*E]})}var K=c.ortho_xspan*b.max_col,L=c.ortho_yspan*b.max_row,v=n.map(function(b){var d=$jscomp.makeIterator(b);b=d.next().value;d=d.next().value;return a.getBSTBin(b,-d,K,L,c.ortho_xoffset,D)});n=v.map(function(a){return a[0]});v=v.map(function(a){return a[1]});var C=Math.min.apply(Math,[].concat($jscomp.arrayFromIterable(n)));n=Math.max.apply(Math,[].concat($jscomp.arrayFromIterable(n)));
var r=Math.min.apply(Math,[].concat($jscomp.arrayFromIterable(v)));v=Math.max.apply(Math,[].concat($jscomp.arrayFromIterable(v)));q=(x-q+1)*(u-m+1);for(m=1;b.panel_opt&&q/m>b.panel_opt.max_visible_area;)m+=1;e.activeTexture(e.TEXTURE0);e.uniform1i(f.uniform.uSampler,0);e.uniform1f(f.uniform.uAlpha,b.alpha/d.max_alpha);q=$jscomp.makeIterator([Math.cos(h),Math.sin(h)]);var G=q.next().value,H=q.next().value;q=function(a){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return[a*G-b*H,
a*H+b*G]};e.enableVertexAttribArray(f.attrib.aPosition);e.enableVertexAttribArray(f.attrib.aTexCoord);(u=g.mosaic[d.level])||(u=g.mosaic[d.level]={});d=Math.ceil(C/m)*m;x=C=!1;for(r=Math.ceil(r/m)*m;r<=v;r+=m)for(var M=-(c.ortho_yspan*(r-b.center_row)+c.ortho_yoffset),y=d;y<=n;y+=m){var p=1==A?r:b.max_row-r+1,t=1==I?y:b.max_col-y+1;if(!(b.row_holes&&b.row_holes.has(p)||b.holes&&b.holes.has([t,p]))){t=[t,p];p=u[t];if(!p){p=b.key+":"+g.index+":"+t;var z=this.buildMosaicTemplateURL(g.url,this.slice,
r,y);p=u[t]=new ViewImage(this,p,z)}p.is_ready?null===p.tex?C|=1:(z=$jscomp.makeIterator(q([c.ortho_xspan*(y-b.center_col)+c.ortho_xoffset,M])),t=z.next().value,z=z.next().value,mat4.identity(this.mv_matrix),mat4.translate(this.mv_matrix,this.mv_matrix,[(t-J)*k,(z-B)*k,0]),mat4.rotate(this.mv_matrix,this.mv_matrix,h,[0,0,1]),mat4.scale(this.mv_matrix,this.mv_matrix,[l*m,w*m,1]),e.uniformMatrix4fv(f.uniform.uMVMatrix,!1,this.mv_matrix),e.bindTexture(e.TEXTURE_2D,p.tex),e.bindBuffer(e.ARRAY_BUFFER,
c.pos_bf),e.vertexAttribPointer(f.attrib.aPosition,c.pos_bf.item_sz,e.FLOAT,!1,0,0),e.bindBuffer(e.ARRAY_BUFFER,this.texcoord_bf),e.vertexAttribPointer(f.attrib.aTexCoord,this.texcoord_bf.item_sz,e.FLOAT,!1,0,0),e.drawArrays(e.TRIANGLES,0,c.pos_bf.item_n)):x|=1}}e.disableVertexAttribArray(f.attrib.aTexCoord);if(x)b.onLoadingImage();else if(C)b.onMissingImage();else b.onLoadedImage()}else b.onLoadingImage()}};function ViewerLabelPanel(a,b){ViewerSingleImagePanel.call(this,a,b);this.draw_contours=!1}ViewerLabelPanel.prototype=Object.create(ViewerSingleImagePanel.prototype);ViewerLabelPanel.prototype.buildTemplateURL=function(a,b){return[a,"label",this.view.submodality].concat([this.canvas.axis,String(b)]).join("/")};ViewerLabelPanel.prototype.buildPreviewTemplateURL=function(a,b){return[a,"label",this.view.submodality].concat([this.canvas.axis,String(b),"preview"]).join("/")};
...
this.mv_matrix);for(var w in f.contours.contour_bf)for(b=$jscomp.makeIterator(f.contours.contour_bf[w]),a=b.next();!a.done;a=b.next())a=a.value,d.bindBuffer(d.ARRAY_BUFFER,a),d.enableVertexAttribArray(e.attrib.aPosition),d.vertexAttribPointer(e.attrib.aPosition,a.item_sz,d.FLOAT,!1,0,0),d.drawArrays(d.LINE_STRIP,0,a.item_n)}}else a.onLoadingImage()}};function View(a,b,c,d,e,f){this.context=a;this.view_class=b;this.modality=c;this.submodality=d;this.key=this.modality+(this.submodality?"."+this.submodality:"");this.prefix=this.modality+(this.submodality?"_"+this.submodality:"")+"_";this.name=e;this.active=!1;this.selectable=!0;this.show_alpha=!1;a=this.context.view_params;b=this.prefix+"_a";this.alpha=b in a?a[b]:this.context.max_alpha;this.context.setScopeVariable(b,this.alpha);this.panels=f;this.img_url=this.layer_opt=this.panel_opt=null;this.empty=
!1;this.visible=!0;this.bg_class={};this.text_class={};this.tooltip=""}View.prototype.loadResource=function(a){};View.prototype.checkPanBounds=function(a){};View.prototype.getLayer=function(){return this.context.layers.indexOf(this.key)};View.prototype.activate=function(){this.show_alpha=this.active=!0;for(var a in this.panels)this.panels[a]&&this.context.canvas[a].activateView(this)};View.prototype.deactivate=function(){this.show_alpha=this.active=!1;for(var a in this.panels)this.panels[a]&&this.context.canvas[a].deactivateView(this)};
View.prototype.setAlpha=function(a){var b=this.context.view_params,c=this.prefix+"_a";b[c]=this.alpha=Math.max(this.context.min_alpha,Math.min(this.context.max_alpha,a));this.context.setScopeVariable(c,this.alpha);return b};View.prototype.setSlice=function(a,b){return(a=this.panels[a])?a.setSlice(b):this.context.view_params};
...
ViewHistPanel.prototype.buildMosaicTemplateURL=function(a,b,c,d){return[a,String(this.view.context.level),String(c),String(d)].join("/")};function HistView(a,b){View.call(this,a,b,"hist","","Histology",{coronal:new ViewHistPanel(this,a.canvas.coronal)})}HistView.prototype=Object.create(View.prototype);
...
MRView.prototype.setSessionName=function(a,b,c){if(-1!=a.indexOf("-")){var d=$jscomp.makeIterator(a.split("-",2));a=d.next().value;d=d.next().value;return this.setVivoAndSession(a,d,b,c)}return this.context.view_params};
...
ViewGlyphPanel.prototype.buildMosaicTemplateURL=function(a,b,c,d){return[a,String(c),String(d)].join("/")};function GlyphView(a,b,c,d){View.call(this,a,b,"glyph",c,d,{coronal:new ViewGlyphPanel(this,a.canvas.coronal)})}GlyphView.prototype=Object.create(View.prototype);
...
ViewerContext.prototype.isViewActive=function(a){return a in this.views&&this.views[a].active};
...
this[c]);c="pan_"+d+"x";var f="pan_"+d+"y";this[c]=parseFloatWithDefault(a[d+"x"]);this[f]=parseFloatWithDefault(a[d+"y"]);this.setScopeVariable(d+"x",this[c]+"");this.setScopeVariable(d+"y",this[f]+"")}this.session_names=[];this.session_name=a.vivo+"-"+a.session;this.max_level=5;this.min_level=2;this.mag_factor=4;this.max_mag=Math.pow(this.mag_factor,this.max_level-this.min_level);e=new ViewerViewClass(this,"accessory-overlay","Accessory Overlays");e.setViews([new GlyphView(this,e,"CSD","CSD glyphs"),
new GlyphView(this,e,"DTI","DTI glyphs"),new LabelView(this,e,"roi","ROI Label"),new LabelView(this,e,"BDAcount","BDA Count Label"),new LabelView(this,e,"MR","MR Label")]);e.setViewDefault("label.BDAcount");this.addViewClass(e);this.has_thickness=!1;e=new ViewerViewClass(this,"mri","MRI");e.setViews([new MRView(this,e,"T2","T2"),new MRView(this,e,"Diffusion_tensor","Diffusion Tensor"),new MRView(this,e,"FA","FA"),new MRView(this,e,"MD","MD"),new MRView(this,e,"Mean_B0","Mean B0"),new MRView(this,
e,"Mean_DW","Mean DW"),new MRView(this,e,"RA","RA"),new MRView(this,e,"VR","VR"),new MRView(this,e,"CMAP","CMAP"),new AggregateMRView(this,e,"t1-template","t1"),new AggregateMRView(this,e,"t2-template","t2"),new AggregateMRView(this,e,"exvivo-fa-template","exvivo-fa"),new AggregateMRView(this,e,"exvivo-structural-template","exvivo-structural"),new AggregateMRView(this,e,"invivo-fa-template","invivo-fa"),new AggregateMRView(this,e,"invivo-md-template","invivo-md"),new AggregateMRView(this,e,"pd-template",
"pd"),new AggregateMRView(this,e,"brainmask","brainmask")]);e.setViewDefault("MR.T2");e.setViewDefault("aggregateMR.t1-template");this.addViewClass(e);e=new ViewerViewClass(this,"block","Block");e.setViews([new BlockView(this,e)]);e.setViewDefault("block");this.addViewClass(e);e=new ViewerViewClass(this,"hist","Histology");e.setViews([new HistView(this,e)]);e.setViewDefault("hist");this.addViewClass(e);for(var g in this.view_classes)this.view_classes[g].loadResource();this.setCanvasElements();this.setLayers(this.layers.slice());
this.setLayers(a.layers.split(","));this.setViews(new Set(a.view.split(",")));for(var h in this.view_classes)this.view_classes[h].updateVisibilityFromViews();this.drawScene();return a};
...
d.activateDefaultViews();this.updatePageState();return this.view_params};
...
d)/c;this[b+"scale"]=1+(this.mag_factor-1)*(a-e)/((this.max_level-(d-1))/c-e)||1;this[b+"magnification"]=Math.pow(this.mag_factor,this.max_level-d);for(var f in this.canvas)this.canvas[f].checkPanBounds();this.updatePageState()};
ViewerContext.prototype.checkSliceBounds=function(a,b){var c=Infinity,d=-Infinity;b=void 0!==b?b:this.axis_prefixes[this.axes.indexOf(a)];var e=b+"slice",f="min_"+e,g="max_"+e,h;for(h in this.views){var k=this.views[h];this.selectable_views.has(k.key)&&(k=k.panels[a])&&(null!==k.min_slice&&k.min_slice<c&&(c=k.min_slice),null!==k.max_slice&&k.max_slice>d&&(d=k.max_slice))}if(Infinity==c||-Infinity==d)d=c=1;this[f]=c;this[g]=d;this.setSlice(a,this[e],b)};
...
ViewerContext.prototype.addView=function(a){this.views[a.key]=a;a.name&&this.layers.push(a.key);this.valid_views.add(a.key);a.selectable&&this.selectable_views.add(a.key);return a};ViewerContext.prototype.addViewClass=function(a){this.view_classes[a.key]=a;for(var b in a.views)this.addView(a.views[b]);return a};
