...
0);for(var f in this.active_views){var g=this.active_views[f].panels[this.axis];if(g&&null!==g.pos_bf){var h=g.getSlice(g.slice);if(h&&h.preview.is_ready&&null!==h.preview.tex){var k=g.attrib,l=k&&"xoffset"in k?k.xoffset:0,u=k&&"yoffset"in k?k.yoffset:0,r=(k&&"horizontal_flip"in k?-1:1)*(k&&"xscale"in k?k.xscale:1),m=(k&&"vertical_flip"in k?-1:1)*(k&&"yscale"in k?k.yscale:1);k=k&&"rotate"in k?k.rotate:0;mat4.identity(this.mv_matrix);mat4.translate(this.mv_matrix,this.mv_matrix,[l,u,0]);mat4.rotate(this.mv_matrix,
this.mv_matrix,k,[0,0,1]);mat4.scale(this.mv_matrix,this.mv_matrix,[r,m,1]);b.uniformMatrix4fv(c.uniform.uPMatrix,!1,this.p_matrix);b.uniformMatrix4fv(c.uniform.uMVMatrix,!1,this.mv_matrix);b.bindTexture(b.TEXTURE_2D,h.preview.tex);b.uniform1f(c.uniform.uAlpha,g.view.alpha/a.max_alpha);b.bindBuffer(b.ARRAY_BUFFER,g.pos_bf);b.enableVertexAttribArray(c.attrib.aPosition);b.vertexAttribPointer(c.attrib.aPosition,g.pos_bf.item_sz,b.FLOAT,!1,0,0);b.bindBuffer(b.ARRAY_BUFFER,g.texcoord_bf);b.enableVertexAttribArray(c.attrib.aTexCoord);
b.vertexAttribPointer(c.attrib.aTexCoord,g.texcoord_bf.item_sz,b.FLOAT,!1,0,0);b.drawArrays(b.TRIANGLES,0,g.pos_bf.item_n)}}}b.useProgram(c.program);b.bindFramebuffer(b.FRAMEBUFFER,e);b.viewport(d[0],d[1],d[2],d[3]);d=this.minimap_size;e=this.ortho.right/d-this.ortho.right;f=this.ortho.top/d-this.ortho.top;mat4.identity(this.mv_matrix);mat4.scale(this.mv_matrix,this.mv_matrix,[d,-d,1]);mat4.translate(this.mv_matrix,this.mv_matrix,[e,-f,0]);b.uniformMatrix4fv(c.uniform.uPMatrix,!1,this.p_matrix);b.uniformMatrix4fv(c.uniform.uMVMatrix,
!1,this.mv_matrix);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,this.composite_tex);b.uniform1i(c.uniform.uSampler,0);b.uniform1f(c.uniform.uAlpha,1);b.bindBuffer(b.ARRAY_BUFFER,this.pos_bf);b.enableVertexAttribArray(c.attrib.aPosition);b.vertexAttribPointer(c.attrib.aPosition,this.pos_bf.item_sz,b.FLOAT,!1,0,0);b.bindBuffer(b.ARRAY_BUFFER,this.texcoord_bf);b.enableVertexAttribArray(c.attrib.aTexCoord);b.vertexAttribPointer(c.attrib.aTexCoord,this.texcoord_bf.item_sz,b.FLOAT,!1,0,0);b.drawArrays(b.TRIANGLES,
...
"magnification"]/b.max_row,l=(h&&"horizontal_flip"in h?-k:k)*(h&&"xscale"in h?h.xscale:1),u=(h&&"vertical_flip"in h?-k:k)*(h&&"yscale"in h?h.yscale:1),r=$jscomp.makeIterator([Math.sign(l),Math.sign(u)]),m=r.next().value;r=r.next().value;var v=$jscomp.makeIterator([(d.pan_x+(h&&"xoffset"in h?h.xoffset:0))*b.max_col,(d.pan_y+(h&&"yoffset"in h?h.yoffset:0))*b.max_row]),w=v.next().value;v=v.next().value;var F=Math.log2(b.max_row),p=Math.pow(2,F),n=c.view_left*p,t=c.view_bottom*p,z=c.view_right*p,B=c.view_top*
p;p=[[n,t],[n,B],[z,t],[z,B]];if(h=h&&"rotate"in h?h.rotate:0){var G=Math.cos(-h),H=Math.sin(-h);p=p.map(function(a){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return[a*G-b*H,a*H+b*G]})}var K=c.ortho_xspan*b.max_col,L=c.ortho_yspan*b.max_row,A=p.map(function(b){var d=$jscomp.makeIterator(b);b=d.next().value;d=d.next().value;return a.getBSTBin(b,-d,K,L,c.ortho_xoffset,F)});p=A.map(function(a){return a[0]});A=A.map(function(a){return a[1]});var E=Math.min.apply(Math,[].concat($jscomp.arrayFromIterable(p)));
p=Math.max.apply(Math,[].concat($jscomp.arrayFromIterable(p)));var x=Math.min.apply(Math,[].concat($jscomp.arrayFromIterable(A)));A=Math.max.apply(Math,[].concat($jscomp.arrayFromIterable(A)));t=(B-t+1)*(z-n+1);for(n=1;b.panel_opt&&t/n>b.panel_opt.max_visible_area;)n+=1;e.activeTexture(e.TEXTURE0);e.uniform1i(f.uniform.uSampler,0);e.uniform1f(f.uniform.uAlpha,b.alpha/d.max_alpha);t=$jscomp.makeIterator([Math.cos(h),Math.sin(h)]);var I=t.next().value,J=t.next().value;t=function(a){var b=$jscomp.makeIterator(a);
a=b.next().value;b=b.next().value;return[a*I-b*J,a*J+b*I]};e.enableVertexAttribArray(f.attrib.aPosition);e.enableVertexAttribArray(f.attrib.aTexCoord);(z=g.mosaic[d.level])||(z=g.mosaic[d.level]={});d=Math.ceil(E/n)*n;B=E=!1;for(x=Math.ceil(x/n)*n;x<=A;x+=n)for(var M=-(c.ortho_yspan*(x-b.center_row)+c.ortho_yoffset),C=d;C<=p;C+=n){var q=1==r?x:b.max_row-x+1,y=1==m?C:b.max_col-C+1;if(!(b.row_holes&&b.row_holes.has(q)||b.holes&&b.holes.has([y,q]))){y=[y,q];q=z[y];if(!q){q=b.key+":"+g.index+":"+y;var D=
this.buildMosaicTemplateURL(g.url,this.slice,x,C);q=z[y]=new ViewImage(this,q,D)}q.is_ready?null===q.tex?E|=1:(D=$jscomp.makeIterator(t([c.ortho_xspan*(C-b.center_col)+c.ortho_xoffset,M])),y=D.next().value,D=D.next().value,mat4.identity(this.mv_matrix),mat4.translate(this.mv_matrix,this.mv_matrix,[(y-w)*k,(D-v)*k,0]),mat4.rotate(this.mv_matrix,this.mv_matrix,h,[0,0,1]),mat4.scale(this.mv_matrix,this.mv_matrix,[l*n,u*n,1]),e.uniformMatrix4fv(f.uniform.uMVMatrix,!1,this.mv_matrix),e.bindTexture(e.TEXTURE_2D,
q.tex),e.bindBuffer(e.ARRAY_BUFFER,c.pos_bf),e.vertexAttribPointer(f.attrib.aPosition,c.pos_bf.item_sz,e.FLOAT,!1,0,0),e.bindBuffer(e.ARRAY_BUFFER,this.texcoord_bf),e.vertexAttribPointer(f.attrib.aTexCoord,this.texcoord_bf.item_sz,e.FLOAT,!1,0,0),e.drawArrays(e.TRIANGLES,0,c.pos_bf.item_n)):B|=1}}e.disableVertexAttribArray(f.attrib.aTexCoord);if(B)b.onLoadingImage();else if(E)b.onMissingImage();else b.onLoadedImage()}else b.onLoadingImage()}};function ViewerLabelPanel(a,b){ViewerSingleImagePanel.call(this,a,b);this.draw_contours=!1}ViewerLabelPanel.prototype=Object.create(ViewerSingleImagePanel.prototype);ViewerLabelPanel.prototype.buildTemplateURL=function(a,b){return[a,"label",this.view.submodality].concat([this.canvas.axis,String(b)]).join("/")};ViewerLabelPanel.prototype.buildPreviewTemplateURL=function(a,b){return[a,"label",this.view.submodality].concat([this.canvas.axis,String(b),"preview"]).join("/")};
...
mat4.identity(this.mv_matrix);a=c[b.axis_prefix+"scale"]*c[b.axis_prefix+"magnification"];var g=this.attrib,h=c["pan_"+b.axis_prefix+"x"]+(g&&"xoffset"in g?g.xoffset:0);c=c["pan_"+b.axis_prefix+"y"]+(g&&"yoffset"in g?g.yoffset:0);var k=(g&&"horizontal_flip"in g?-a:a)*(g&&"xscale"in g?g.xscale:1),l=(g&&"vertical_flip"in g?-a:a)*(g&&"yscale"in g?g.yscale:1);g=g&&"rotate"in g?g.rotate:0;mat4.translate(this.mv_matrix,this.mv_matrix,[-h*a,-c*a,0]);mat4.scale(this.mv_matrix,this.mv_matrix,[k,l,1]);mat4.rotate(this.mv_matrix,
this.mv_matrix,g,[0,0,1]);d.uniformMatrix4fv(e.uniform.uPMatrix,!1,b.p_matrix);d.uniformMatrix4fv(e.uniform.uMVMatrix,!1,this.mv_matrix);d.activeTexture(d.TEXTURE0);d.bindTexture(d.TEXTURE_2D,f.image.tex);d.uniform1i(e.uniform.uSampler,0);d.bindBuffer(d.ARRAY_BUFFER,this.pos_bf);d.enableVertexAttribArray(e.attrib.aPosition);d.vertexAttribPointer(e.attrib.aPosition,this.pos_bf.item_sz,d.FLOAT,!1,0,0);d.bindBuffer(d.ARRAY_BUFFER,this.texcoord_bf);d.enableVertexAttribArray(e.attrib.aTexCoord);d.vertexAttribPointer(e.attrib.aTexCoord,
this.texcoord_bf.item_sz,d.FLOAT,!1,0,0);d.drawArrays(d.TRIANGLES,0,this.pos_bf.item_n);d.disableVertexAttribArray(e.attrib.aTexCoord);d.bindTexture(d.TEXTURE_2D,null);if(this.draw_contours&&null!==f.contours.contour_bf){e=b.shdr.color;d.useProgram(e.program);mat4.identity(this.mv_matrix);mat4.translate(this.mv_matrix,this.mv_matrix,[-h*a,-c*a,0]);mat4.scale(this.mv_matrix,this.mv_matrix,[k,l,1]);d.uniform4fv(e.uniform.vColor,[1,1,1,1]);d.uniformMatrix4fv(e.uniform.uPMatrix,!1,b.p_matrix);d.uniformMatrix4fv(e.uniform.uMVMatrix,
!1,this.mv_matrix);for(var u in f.contours.contour_bf)for(b=$jscomp.makeIterator(f.contours.contour_bf[u]),a=b.next();!a.done;a=b.next())a=a.value,d.bindBuffer(d.ARRAY_BUFFER,a),d.enableVertexAttribArray(e.attrib.aPosition),d.vertexAttribPointer(e.attrib.aPosition,a.item_sz,d.FLOAT,!1,0,0),d.drawArrays(d.LINE_STRIP,0,a.item_n)}}else a.onLoadingImage()}};function View(a,b,c,d,e,f,g){this.context=a;this.id=b;this.view_class=c;this.modality=d;this.submodality=e;this.key=this.modality+(this.submodality?"."+this.submodality:"");this.prefix=this.modality+(this.submodality?"_"+this.submodality:"")+"_";this.name=f;this.active=!1;this.selectable=!0;this.show_alpha=!1;a=this.context.view_params;b=this.prefix+"_a";this.alpha=b in a?a[b]:this.context.max_alpha;this.context.setScopeVariable(b,this.alpha);this.panels=g;this.img_url=this.layer_opt=this.panel_opt=
